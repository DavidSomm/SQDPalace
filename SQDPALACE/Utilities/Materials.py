...
class Material:
    def __init__(self, name="", **kwargs):
        if name == "":
            ...
            #Checchin et al. (2022) Measurement of the Low-Temperature Loss Tangent 
            #of High-Resistivity Silicon Using a High- Q Superconducting Resonator, PRA
            if name == "silicon" or name == "siliconcold" or name == "siliconcryo":
                self.permittivity = 11.45
                self.permeability = 1
                self.loss_tangent = 2.7e-6
